...
return [
    ...
    */
    ...
    "between"          => [
        "numeric" => "Стойността трябва да бъде между :min и :max.",
        "file"    => "Стойността трябва да бъде между :min и :max килобайта.",
        "string"  => "Стойността трябва да бъде между :min и :max знака.",
        "array"   => "Стойността трябва да има между :min - :max елемента.",
    ],
    ...
    "different"        => "Полеот за :attribute и това за :other трябва да са различни.",
    ...
    "numeric"               => "Полето трябва да съдържа число.",
    ...
    "unique"                => "Полето за вече съществува.",
